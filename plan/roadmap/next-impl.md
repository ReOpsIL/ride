...
| 11 | D1, D2 in parallel; then D3; then D4–D6 | D1 and D2 merged (D2 fixtures captured from lldb-dap 21.0.0 via a core file because developer mode is off); D3 merged; R27 merged and reviewed: R28 after D5; D4 merged (301 app tests, self-test 86/86 with the live debug step skipped); D5 after R27 |
