...
enum Shortcuts {
    static let entries: [ShortcutEntry] = [
        ...
        ShortcutEntry(id: "sym", name: "Go to Symbol in File / Project", keys: "⌥⌘O · ⇧⌥⌘O"),
        ...
        ShortcutEntry(id: "check", name: "Check / Check Project", keys: "⌥⌘B · ⇧⌥⌘B"),
        ShortcutEntry(id: "run", name: "Build / Run / Run Tests", keys: "⌘B · ⌘R · ⇧⌘R"),
        ShortcutEntry(id: "stop", name: "Stop", keys: "⌘."),
        ShortcutEntry(id: "panels", name: "Sidebar / Run / Problems / Outline", keys: "⌘1 · ⌘4 · ⌘6 · ⌘7"),
