...
extension SelfTestSteps {
    ...
    private static func constantSteps(
        ...
        [
            ...
            SelfTestStep(name: "constant undo", until: { !e.lines.contains(declaration) }, timeout: 10, run: { e.undo() }, check: {
    ...
    private static func inlineSteps(
        ...
        [
            ...
            SelfTestStep(name: "inline undo", until: { e.lines.contains(declaration) }, timeout: 10, run: { e.undo() }, check: {
